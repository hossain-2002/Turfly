        ...
        <div>
          ...
          <div className="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              ...
              required
              className={`focus:ring-[#10B981] focus:border-[#10B981] block w-full pl-10 pr-10 sm:text-sm rounded-md py-2.5 border text-slate-900 ${confirmPassword && confirmPassword !== password
